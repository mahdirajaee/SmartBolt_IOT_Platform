...
INFLUXDB_PORT = 8086
INFLUXDB_ORG = "smartbolt"  # Your organization name
INFLUXDB_TOKEN = "koWQWG4CbGbc7jBX4Oqc6-8ueXM61ZX0Bdmu2wCvXAgh6XMGCRz2D_DceTOafglIUJzU_8Z4VCBX1FdhMQ9d_w=="  # Your API token
INFLUXDB_BUCKET = "sensor_data"  # The bucket we'll use for all data
